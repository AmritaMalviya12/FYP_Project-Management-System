...
import { Archive, FileText, FileCode, File, FilePlus } from "lucide-react";
      ...
      <div className="card">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <p className="text-sm text-slate-600 mb-2">Upload your project report (PDF, DOC)</p>
          ...
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <p className="text-sm text-slate-600 mb-2">Upload your presentation (PPT, PPTX, PDF)</p>
            <label className="btn-outline cursor-pointer">Choose File
          ...
          <div className="border-2 border-dashed border-slate-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <p className="text-sm text-slate-600 mb-2">Upload your  source code(ZIP, RAR, TAR)</p>
            <label className="btn-outline cursor-pointer">Choose File
      ...
      <div className="card">
        ...
        {(files || []).length === 0 ? (
          <div className="text-center py-4">
            <FilePlus className="w-26 h-16 text-slate-300 mx-auto mb-4" />
