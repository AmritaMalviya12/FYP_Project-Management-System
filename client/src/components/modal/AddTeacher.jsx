          ...
          <form onSubmit={handleCreateTeacher} className="space-y-4">
            ...
            <div>
              ...
              <input type="email" required value={formData.email} onChange={(e) => setFormData({ ...formData, email: e.target.value })
                ...
                className="input-field w-full py-1 border-b border-salte-600 focus: outline-none" />
            </div>
            {/* password field */}
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">
            ...
            <div>
              ...
              <select className="input-field w-full py-2 border-b border-salte-600 focus:outline-none" required value={formData.expertise} onChange={(e) => setFormData({ ...formData, expertise: Array(e.target.value) })
              }>
            ...
            <div>
              ...
              <input type="number" required max={10} min={1} value={formData.maxStudents} onChange={(e) => setFormData({ ...formData, maxStudents: Number(e.target.value) })
